...
module.exports = {
    ...
    async execute(message, args) {
        ...
        if (
         ...
         // Không cần sendTyping ở đây nữa, handleReplyCommand sẽ xử lý
        await handleReplyCommand(message, prompt, config.defaultLanguage); // Không cần await trước handleReplyCommand
    },
};